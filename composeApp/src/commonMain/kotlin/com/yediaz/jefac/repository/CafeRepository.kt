...
import com.yediaz.jefac.data.OrderItem
...
class CafeRepository {
    ...
    // Órdenes activas
    // ─────────────────────────────────────────
    suspend fun getActiveOrders(businessId: String): Result<List<com.yediaz.jefac.data.Order>> {
        return try {
            ...
            Result.Success(json.decodeFromString<List<com.yediaz.jefac.data.Order>>(response))
        } catch (e: Exception) {
