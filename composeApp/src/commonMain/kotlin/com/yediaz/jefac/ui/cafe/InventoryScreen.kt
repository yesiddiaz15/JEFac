...
fun InventoryScreen(user: AppUser) {
    val viewModel: InventoryViewModel = viewModel(
        factory = InventoryViewModel.Factory(user.business_id)
    )
    ...
    Column(
        ...
        val lowStock = uiState.products.filter { it.stock <= it.min_stock }
            ...
            LazyColumn(
                ...
                items(uiState.products) { product ->
                    ...
                    val stockLevel = when {
                        ...
                        product.stock <= product.min_stock -> StockLevel.LOW
                        else -> StockLevel.OK
                    }
